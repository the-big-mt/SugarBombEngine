...
{
public:
	SbRenderContextWGL(ISystem &aSystem, HDC ahDeviceContext);
	~SbRenderContextWGL();
private:
	static HGLRC CreateOpenGLContextOnDC(const HDC ahDeviceContext, const bool abDebugContext);
private:
	ISystem &mSystem;
	
	HGLRC mhGLRC; ///< handle to GL rendering context
