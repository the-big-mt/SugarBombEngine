...
================================================
*/
struct ISignInManager
{
	// Register a local controller user to the passed in input device
	virtual void RegisterLocalUser(int inputDevice) = 0;
	
	// Master user always index 0
	virtual idLocalUser *GetMasterLocalUser() const = 0;
