...
========================
*/
SbSoundChannel::~SbSoundChannel() = default;
...
========================
*/
bool SbSoundChannel::CanMute() const
{
	return true;
};
...
========================
*/
bool SbSoundChannel::IsLooping() const
{
...
========================
*/
bool SbSoundChannel::CheckForCompletion(int currentTime)
{
...
========================
*/
void SbSoundChannel::UpdateVolume(int currentTime)
{
	SbSoundWorldLocal *soundWorld{emitter->soundWorld};
...
========================
*/
void SbSoundChannel::UpdateHardware(float volumeAdd, int currentTime)
{
	SbSoundWorldLocal *soundWorld{emitter->soundWorld};
