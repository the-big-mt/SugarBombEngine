...
#pragma pack(1)
    ...
    struct Data
    {
        ...
        */
        unsigned int version; // 0.94 in most files; 1.7 in recent versions of Update.esm
		int records;          // Number of records and groups (not including TES4 record itself)
		int nextObjectId;     // Next available object ID
