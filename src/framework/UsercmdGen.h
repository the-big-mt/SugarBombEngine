...
const int IMPULSE_2				= 2;			// weap 2/switch ammo type
...
//const int IMPULSE_8				= 8;			// switch ammo type (FNV)
...
//const int IMPULSE_18			= 18;			// center view (unused)
const int IMPULSE_19			= 19;			// show Pip-Boy
const int IMPULSE_20			= 19;			// show Scoreboard
